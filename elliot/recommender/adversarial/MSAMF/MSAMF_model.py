...
class MSAMF_model(keras.Model):
    ...
    def __init__(self,
                 factors=200,
                 learning_rate=0.001,
                 l_w=0, l_b=0, eps=0, l_adv=0, eps_iter=0, nb_iter=1,
                 num_users=100,
                 num_items=100,
                 name="MSAMF",
                 **kwargs):
    ...
    def train_step(self, batch, user_adv_train=False):
        ...
        with tf.GradientTape() as tape:
            ...
            if user_adv_train:
                ...
                self.build_iterative_perturbation(batch)
    ...
    # @tf.function
    def predict(self, start, stop, adversarial=False, **kwargs):
        if adversarial:
    ...
    # @tf.function
    def build_iterative_perturbation(self, batch):
        """
        ...
        for _ in range(self._nb_iter):
            ...
            step_Delta_Gu = tf.nn.l2_normalize(grad_Gu, 1) * self._eps_iter
            step_Delta_Gi = tf.nn.l2_normalize(grad_Gi, 1) * self._eps_iter
